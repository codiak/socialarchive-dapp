...
function App() {
  const activeLink = (pathname: string, startsWith?: boolean) => {
    let isActive = (startsWith && window.location.pathname.startsWith(pathname)) ||
  ...
  return (
    <div className="wrapper">
      ...
      <header className="App-header">
        ...
        <div className="menu">
          <a className={activeLink('/')} href="/">Upload</a>
          <a className={activeLink('/browse', true)} href="/browse">Browse</a>
        </div>
