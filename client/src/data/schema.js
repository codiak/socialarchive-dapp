let archive = {
  userInfo: {
    ...
    displayName: "SocialArchive",
  },
  archiveInfo: {
    sizeBytes: "211086",
    generationDate: "2022-01-05T00:54:44.547Z",
  ...
  userListInfo: {
    url: "https://twitter.com/SocialArchiveCo/lists/1478162721589788672",
  },
  moment: {
  ...
  p13nData: {
    ...
    interests: {
      ...
      audienceAndAdvertisers: {
        numAudiences: "56",
        advertisers: ["@CallofDuty", "@HBO", "@WonderYearsABC", "@adidas", "@fabriik_market", "@fold_app", "@hbomax", "@peacockTV"],
    ...
    locationHistory: ["Minneapolis, MN, USA", "LOS ANGELES, USA"],
    inferredAgeInfo: {
      age: ["13-54"],
      birthDate: "",
    },
  ...
  media: [
    {
      name: "93710905290770-YNyHklGt.jpg",
      type: "jpg",
      data: "",
      id: "YNyHklGt.jpg",
      category: "media",
    ...
    {
      name: "76456984010755-FCVkCXSaUAA_IVN.mp4",
      type: "mp4",
      data: "",
      id: "FCVkCXSaUAA_IVN.mp4",
      category: "media",
    },
  ],
  name: "76456984010755-FCVkCXSaUAA_IVN.mp4",
